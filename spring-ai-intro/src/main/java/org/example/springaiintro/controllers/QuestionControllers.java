package org.example.springaiintro.controllers;
...
import org.example.springaiintro.services.OpenAIService;
...
public class QuestionControllers {
    ...
    public QuestionControllers(OpenAIService openAIService) {
